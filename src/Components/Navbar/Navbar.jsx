...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <li>
    <NavLink className={({isActive}) => isActive ? 'text-indigo-600':''} to='/cart'><IoMdCart size={20}/>
</NavLink>
    </li>
    
    <li>
    <NavLink className={({isActive}) => isActive ? 'text-indigo-600':''} to='/favourite'><MdBookmarkAdd size={20}/>
</NavLink>
    </li>
      </ul>
    </div>
